    ...
    <div className="menu-container">
      <div className="left-panel">
        ...
        <p className="desc">
          ...
          are prohibited from using the same without permission of Max's Group
          Inc. or such other parties. The materials on this site are protected
          by copyright and no part of such materials may be modified,
          reproduced, stored in a retrieval system, tansmitted(in any form or by
          any means), copied, distributed, used for creating derivative works or
          used in any other way for commercial or public purposes without the
        ...
        <p className="note">
          Hunger Halt provides convenient delivery services to major areas
          within Greater Manila and a number of nearby provincial zones. To
          ensure smooth processing and effcient service, we require a minimun
          order amount of Php 300. This policy helps us maintain quality and
          timely deliveries for all our valued customers.
        </p>
      </div>
        ...
        <div className="drinks">
          ...
          <div className="item-list">
            <div className="item">
              ...
              <p>
                Cookies & Cream Chiller with Choco
                <br />
                <span></span>
              </p>
            </div>
